...
Define(
  ...
  [LimitConstraint("555 scramblers", CanScramble555(), 8, 5),
   LimitConstraint("777 scramblers during FM", And(CanScramble777Relaxed(), Not(CompetingIn(_333fm))), 4, 10),
   LimitConstraint("555 scramblers during FM", And(CanScramble555(), Not(CompetingIn(_333fm))), 4, 10),
   LimitConstraint("555 semi scramblers", And(CanScramble555(), (PsychSheetPosition(_555) > 150)), 7, 5),
   LimitConstraint("666 scramblers", CanScramble666(), 8, 5),
   LimitConstraint("777 scramblers", CanScramble777(), 8, 5),
   LimitConstraint("Clock scramblers", CanScrambleClock(), 8, 5),
   LimitConstraint("Clock semi scramblers", And(CanScrambleClock(), (PsychSheetPosition(_clock) > 150)), 8, 5),
